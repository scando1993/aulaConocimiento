...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-primary" href="{{ route('respuesta.index') }}"> Back</a>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Es_correcta:</strong>
                {!! Form::number('es_correcta', null, array('placeholder' => 'es_correcta','class' => 'form-control')) !!}
            </div>
        </div>
